    ...
    public partial class App : Application
    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            try
            {
                ...
                Logs.CardRemovedFromDeck += (cardId, entityId) => Overlays.ApplyCardRemovedFromDeck(cardId, entityId);
                Logs.CardAddedToDeck += (cardId, entityId) => Overlays.ApplyCardAddedToDeck(cardId, entityId);
